...
const sjwcarules = ({conferences, teams,regions,ageGroup,division})=>{
        ...
        const [SelectedConference, SetSelectedConference]= useState(conferences[1])
                ...
                TeamList.map((Team,i)=>{
                    return(
                        <li key={i}>
                            ...
                            <ViewSelectedTeamBtn href={`/team/${Team.id}`} Conference={`Thunder`} />
                        </li>
                    )
                })
            }

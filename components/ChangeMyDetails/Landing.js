...
const ChangeMyDetailsLanding = ({setProgress,setPlayerResponse, StoreEmail})=>{
    ...
    return(
        <>
            ...
            <FormElementsContainer>
                ...
                <Button variant="contained" onClick={handleClick} disabled={disabled}>Find Players</Button>
                </FormElementGroup>
        </>
    )
}

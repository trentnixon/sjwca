...
const DevelopFriendships = (props) => {
  ...
  return (
    <div
      className={`${Section3Styles.Top} ${Section3Styles.Layout}`}
      id="Develop"
    >
      <H1>
        development of cricketing skills, and the building of life long
        friendships
      </H1>
      <Runnersvg />
    </div>
...
const EnjoyableWay = (props) => {
  ...
  return (
    <div
      className={`${Section3Styles.Bottom} ${Section3Styles.Layout}`}
      id="Regions"
    >
      <H1>IN A FUN, SAFE AND ENJOYABLE ENVIRONMENT IN OVER 10 SYDNEY REGIONS</H1>
      <Mapsvg />
    </div>
  );
};
...
const Mapsvg = () => {
  return (
    <svg viewBox="0 0 1287 1287" fill="#C9E0FF">
      <path
        d="M1099.31 160.875L1090.73 162.484L804.375 273.487L482.625 160.875L180.18 262.763C168.919 266.516 160.875 276.169 160.875 288.503V1099.31C160.875 1114.33 172.672 1126.12 187.688 1126.12L196.268 1124.52L482.625 1013.51L804.375 1126.12L1106.82 1024.24C1118.08 1020.48 1126.12 1010.83 1126.12 998.498V187.688C1126.12 172.672 1114.33 160.875 1099.31 160.875ZM804.375 1018.88L482.625 905.726V268.125L804.375 381.274V1018.88Z"
        fill="#C9E0FF"
      />
    </svg>
  );

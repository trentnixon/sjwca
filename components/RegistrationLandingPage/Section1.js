...
const Section1 = (props)=>{
    ...
    const GSAP = ()=>{
      ...
      gsap.timeline({
        ...
        .fromTo(".IMG img", { xPercent:100,opacity:0},{xPercent:-.5,opacity:1,duration: 2.5,ease: "power2.out"},"section1")
        .fromTo("#Copy h2", { yPercent:-30,opacity:0},{yPercent:0,opacity:1,duration: 2.5,ease: "power2.out"},"section1")
        .fromTo("#Copy h1", { yPercent:-30,opacity:0},{yPercent:0,opacity:1,duration: 2.5,ease: "power2.out"})
        .fromTo("#WantToPlay svg",{ scale:0},{scale:1,duration: 2.5,ease: "power2.out"},"section1")
    }
    ...
    return(
      <section  className={` ${WantToPlaystyles.WantToPlay}`} id="WantToPlay">
              ...
              <div className={` ${WantToPlaystyles.Copy}`} id='Copy'>
                <H2>{registrationPage.ReasonsToPlay[0].Reason}</H2>

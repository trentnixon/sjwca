    ...
    return(
      <section  className={`${JoinOver.JoinOver}`} id="JoinOver">
            ...
            <div className={`${JoinOver.CopyContainer}`}>
              <div className={`${JoinOver.H1} H1_1`}><H1>{registrationPage.ReasonsToPlay[2].Reason}</H1></div>
              <div className={`${JoinOver.H1} H1_2`}><H1>{registrationPage.ReasonsToPlay[3].Reason}</H1></div>
              <div className={`${JoinOver.H1} H1_3`}><H1>{registrationPage.ReasonsToPlay[4].Reason}</H1></div>
